//la  stage.innerHTML = '' -----> clearStage(); de inlocuit pt tema;
// these are HTML elements:   const { name, surname, phone, email } = form;
// cancel action button: stage.addEventListener('click', (event) => {  const { target } = event;
// create contact: stage.addEventListener('submit', (event) => {
